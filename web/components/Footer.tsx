    ...
    <footer id="contact" className="bg-black text-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <div className="mt-12 max-w-2xl text-xl sm:text-2xl mx-auto text-center font-medium text-gray-400">
          Building OnlyCars has been an incredibly fun effort across many people
          at OnlyCars and our frens at other companies. We&apos;re always
        ...
        <p className="mt-10 text-center text-md leading-5 text-zinc-500">
          &copy; {new Date().getFullYear()} BlitzCraft Labs. All rights
          reserved. <br />
          OnlyCars and BlitzCraft Labs are trademarks of BlitzCraft
          Technologies.
        </p>
      </div>
    </footer>
