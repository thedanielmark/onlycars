...
import RPC from "@/utils/viemRPC"; // for using viem

const clientId =
  "BBd7SjmcKtW1CBVL0WS5yFD92QvpEBN0hFJ23ZJJo-9I2A3FsiabbBtFHunqv44CvroZ6nP0RxjwY35ZDTQYqus"; // get from https://dashboard.web3auth.io
        ...
        const openloginAdapter = new OpenloginAdapter({
          ...
          adapterSettings: {
            ...
            loginConfig: {
              // Google login
              google: {
                verifier: "onlycars-ethonline", // Please create a verifier on the developer dashboard and pass the name here
                typeOfLogin: "google", // Pass on the login provider of the verifier you've created
                clientId:
                  "49428790703-pqb1o93ice93l1duvq2j32f6itkuna6i.apps.googleusercontent.com", // Pass on the clientId of the login provider here - Please note this differs from the Web3Auth ClientID. This is the JWT Client ID
              },
            },
            mfaSettings: {
              deviceShareFactor: {
